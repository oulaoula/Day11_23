			...
			<form id="regForm" method="post" action="register" onsubmit="return checkForm(this)">
				<table>
					...
					<tr>
						...
						<td><input class="text verycode" type="text" id="newCode" name = "veryCode" onfocus="FocusItem(this)" onblur="checkValidateCode();" maxlength="4"/><img id="veryCode"  src="doS3" /><a onclick="changeCode()">看不清换一张</a><span id="Code"></span></td>
					</tr>
					<tr>
						<td></td>
